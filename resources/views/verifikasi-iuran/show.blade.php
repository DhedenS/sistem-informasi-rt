            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-5">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('verifikasi-iuran.export-pengajuan-excel', $pengajuanIuran) }}"
                           class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-emerald-600 text-white font-semibold text-xs hover:bg-emerald-700 transition shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            Export Excel Rekap Blok Ini
                        </a>
